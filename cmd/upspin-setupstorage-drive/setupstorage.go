...
setupstorage-drive will add the Upspin Google Drive Storage application 
to your Drive account. It then writes the obtained OAuth2 token information
to $where/$domain/serviceaccount.json and updates the server configuration
